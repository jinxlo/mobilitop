...
export function HeroSlider({ slides, settings }: { slides: HeroSlide[]; settings: SiteSettings }) {
  ...
  return (
    <section className="relative isolate overflow-hidden bg-[radial-gradient(circle_at_top_left,#fff7df_0,#f8efe3_32%,#eef4fa_70%,#fbfaf8_100%)] py-12 md:py-20">
      ...
      <div className="container-page grid items-center gap-12 lg:grid-cols-[1.04fr_0.96fr]">
        <div>
          ...
          <h1 className="mt-6 max-w-4xl text-5xl font-black leading-[0.96] tracking-[-0.055em] text-[#102A43] md:text-7xl">
            {title}
          </h1>
          <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-700 md:text-xl md:leading-9">{subtitle}</p>
        ...
        <div className="relative">
          ...
          <div className="relative overflow-hidden rounded-[2.5rem] bg-[#102A43] p-4 text-white shadow-2xl">
            <div className="relative h-[560px] overflow-hidden rounded-[2rem] border border-white/15">
              ...
              <div className="absolute inset-x-0 bottom-0 p-6">
                ...
                <h2 className="mt-3 max-w-lg text-4xl font-black leading-none">Colchones, bases y accesorios para cada habitación</h2>
